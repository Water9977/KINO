...
export default function HomePage() {
  ...
  return (
    <main className="relative h-screen w-screen overflow-hidden" style={{ background: '#0a0a0a' }}>
      {/* Layer 0 — EvilEye WebGL atmospheric background */}
      ...
      {/* Vignette — darkens edges so center content reads cleanly */}
      <div
        className="absolute inset-0 z-[5] pointer-events-none"
        style={{
          background:
            'radial-gradient(ellipse 70% 70% at 50% 50%, transparent 30%, rgba(10,10,10,0.75) 100%)',
        }}
      />
      ...
      {/* Layer 2 — Center column */}
      <div className="relative z-20 h-full flex flex-col items-center justify-center gap-7 text-center px-6">
        ...
        >
          ...
          <span
            style={{
              color: '#2563eb',
              filter: 'drop-shadow(0 0 48px rgba(37,99,235,0.55))',
            }}
          >
            O
          </span>
