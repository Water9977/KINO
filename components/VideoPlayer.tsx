    ...
    return (
        <div className="w-full space-y-6">
            <div className="relative aspect-video w-full overflow-hidden rounded-2xl bg-black shadow-2xl shadow-[#2563eb]/10 border border-white/5 group ring-1 ring-white/10">
                {!hasUserConsent ? (
                    // Initial Consent Screen - Minimal Redesign
                    ...
                    // Play Button Overlay - Minimal Glowing Icon
                    ...
                    <div className="flex bg-white/5 rounded-lg p-1 border border-white/5">
                        {videoProviders.map((provider, index) => (
                            <button
                                ...
                                className={`flex items-center gap-2 px-4 py-1.5 rounded-md text-xs font-bold transition-all ${currentServer === index
